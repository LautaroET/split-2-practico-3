...
import {obtenerSuperHeroePorId,obtenerTodosLosSuperHeroes,buscarSuperHeroesPorAtributos,obtenerSuperHeroesMayoresDe30} from '../services/superheroesService.mjs'
